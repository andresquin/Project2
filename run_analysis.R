...
#Set directory after unzip the file 
...
testData1 = cbind(yTest,subjectTest,xTest);
...
tidyData = aggregate(finalData[,names(finalDataNoActivityType) != c('activityId','subjectId')],by=list(activityId=finalDataNoActivityType$activityId,subjectId = finalDataNoActivityType$subjectId),mean);
